...
const testCases = [{
  ...
  inputFilename: 'iyarhashar-ideas.txt',
  artifactFilename: 'iyarhashar-ideas-output.json',
  expectedOutputFilename: 'iyarhashar-ideas-expected-output.json'
}, {
  inputFilename: 'gerwick-ideas.txt',
  artifactFilename: 'gerwick-ideas-output.json',
  expectedOutputFilename: 'gerwick-ideas-expected-output.json'
}, {
  ...
  inputFilename: '00-anb-religion.txt',
  artifactFilename: '00-anb-religion-output.json',
  expectedOutputFilename: '00-anb-religion-expected-output.json'
}, {
  ...
  inputFilename: 'beepeck-missions.txt',
  artifactFilename: 'beepeck-missions-output.json',
  expectedOutputFilename: 'beepeck-missions-expected-output.json'
}];
